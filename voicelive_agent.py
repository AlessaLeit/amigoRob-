...
def parse_arguments():
    ...
    parser.add_argument(
        "--api-key",
        help="Azure VoiceLive API key. If not provided, will use AZURE_VOICELINE_API_KEY environment variable.",
        type=str,
        default=os.environ.get("AZURE_VOICELINE_API_KEY"),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.environ.get("AZURE_VOICELINE_ENDPOINT", "wss://eastus.api.speech.microsoft.com/voice-live/v1"),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.environ.get("VOICELINE_MODEL", "gpt-4o-realtime-preview"),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.environ.get("VOICELINE_VOICE", "alloy"),
        choices=[
            "alloy",
            "echo",
            "fable",
    ...
    parser.add_argument("--use-token-credential", help="Use Azure token credential instead of API key", action="store_true"    )
